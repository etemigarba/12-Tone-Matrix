...
displayPitchClassMatrix(getTwelveToneMatrix(getPichClassOriginalRow(chromaticPitches,originalRow)));
displayPitchNotesMatrix(getTwelveToneMatrix(getPichClassOriginalRow(chromaticPitches,originalRow)));
...
//method for displaying the Pitch Class of the Twelve Tone Matrix
public void displayPitchClassMatrix(Object [][] getTwelveToneMatrix){
System.out.println("Displaying the Pitch Class: ");
...
//method for displaying the Pitch Notes of the Twelve Tone Matrix
public void displayPitchNotesMatrix(Object [][] getTwelveToneMatrix){
System.out.println("Displaying the Pitch Notes: ");
for(byte i=0; i<getTwelveToneMatrix.length; i++){
for(byte j=0; j<getTwelveToneMatrix.length; j++){
